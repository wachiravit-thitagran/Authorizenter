...
class Plugin {
	...
	private function init_updater() {
		$repo = apply_filters( 'autorizenter_github_repo', defined( 'AUTORIZENTER_GITHUB_REPO' ) ? AUTORIZENTER_GITHUB_REPO : '', 'core' );
		if ( '' === $repo ) {
			return;
		}
		$updater = new Github_Updater( AUTORIZENTER_CORE_FILE, 'autorizenter-core', $repo, AUTORIZENTER_CORE_VERSION, 'autorizenter-core.zip' );
		$updater->hooks();
	}
	...
	public function load_textdomain() {
		load_plugin_textdomain( 'autorizenter', false, dirname( plugin_basename( AUTORIZENTER_CORE_FILE ) ) . '/languages' );
	}
