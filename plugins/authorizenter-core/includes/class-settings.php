...
/**
 * Reads/writes the single options blob used by Authorizenter.
 *
...
class Settings {
	...
	const OPTION = 'authorizenter_settings';
	...
	public function defaults() {
		return array(
			...
			'policy'       => array(
				...
				'block_message'          => __( 'Your account is not permitted to sign in to this site.', 'authorizenter' ),
			),
			'users'        => array(
				'auto_provision' => true,
	...
	public function get_context( $id = 'default' ) {
		 ...
		 */
		return apply_filters( 'authorizenter_context', $resolved, $id );
	}
	...
	private function derive_key() {
		$material = ( defined( 'AUTH_KEY' ) ? AUTH_KEY : 'authorizenter' ) . ( defined( 'AUTH_SALT' ) ? AUTH_SALT : 'salt' );
