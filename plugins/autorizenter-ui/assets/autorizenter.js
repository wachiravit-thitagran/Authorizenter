/**
 * Autorizenter UI — questions form submission against the Core REST API.
 */
( function () {
	'use strict';

	var form = document.getElementById( 'autorizenter-questions-form' );
	...
	form.addEventListener( 'submit', function ( e ) {
		...
		fetch( window.AutorizenterUI.restUrl + '/answers', {
			method: 'POST',
			headers: {
				'Content-Type': 'application/json',
				'X-WP-Nonce': window.AutorizenterUI.nonce
			},
